<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admin_book_inventory.aspx.cs" Inherits="Library_Management_System.admin_book_inventory" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="book_inventory/books.png" id="imgview" width="100px" />
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:FileUpload onchange="readURL(this);" ID="FileUpload1" runat="server" 
                                    class="form-control" BorderColor="#008080" />
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server"
                                            placeholder="Book ID" BorderColor="#008080"></asp:TextBox>
                                        <asp:Button ID="Button3" runat="server" Text="Go" class="btn btn-success" OnClick="Button3_Click" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList1" BorderColor="#008080" runat="server">
                                ...
                                <label>
                                    Publisher
                                Name</label><div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList2" BorderColor="Teal" runat="server" >
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList class="form-control" ID="DropDownList3" BorderColor="Teal" runat="server" >
                                        <asp:ListItem Text="Select" Value="Select" />
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox3" class="form-control" runat="server" TextMode="Date"
                                        placeholder="date" BorderColor="#008080"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox11" runat="server"
                                        placeholder="Edition" BorderColor="#008080"></asp:TextBox>
                                </div>
                                <label>
                                    Actual Stock
                                </label>
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server"
                                        placeholder="Actual Stock" BorderColor="#008080" TextMode="Number"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server"
                                        placeholder="Cost" BorderColor="#008080" TextMode="Number"></asp:TextBox>
                                </div>
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server"
                                        placeholder="Stock" BorderColor="#008080" TextMode="Number" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox13" runat="server"
                                        placeholder="Pages" BorderColor="#008080"></asp:TextBox>
                                </div>
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server"
                                        placeholder="Isuued Books" BorderColor="#008080" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox14" runat="server"
                                            placeholder="Book Description" BorderColor="#008080" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="row"> 
                            <div class="col-4">
                                <div class="d-grid gap-2">
                                    <asp:Button ID="Button4" runat="server" Text="Add" class="btn btn-success btn-block btn-lg" OnClick="Button4_Click" />                                    
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="d-grid gap-2">
                                    <asp:Button ID="Button2" runat="server" Text="Delete" class="btn btn-danger btn-block btn-lg" OnClick="Button2_Click" />                                    
                                </div>
                            </div>    
                        </div>
