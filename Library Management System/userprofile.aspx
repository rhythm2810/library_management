                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" 
                                        placeholder="Pincode" BorderColor="#008080" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox6" runat="server" 
                                        placeholder="User ID" BorderColor="#008080" ReadOnly="True"></asp:TextBox>
                                </div>
                             </div>
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox10" runat="server" 
                                        placeholder="Password" BorderColor="#008080" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox Class="form-control" ID="TextBox2" runat="server" 
                                        placeholder="New Password" BorderColor="#008080"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="d-grid gap-2">
                                        <asp:Button ID="Button3" runat="server" Text="Update" class="btn btn-success btn-block btn-lg" />                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge rounded-pill bg-primary" ID="Label2" runat="server" Text="Info about book due date"></asp:Label>
                                </center>                                
                            </div>
                        </div>
